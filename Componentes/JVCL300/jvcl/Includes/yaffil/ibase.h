 ...
 */
/*
$Id: ibase.h,v 1.1 2003/09/23 18:11:10 peter3 Exp $
 */
...
void        ISC_EXPORT isc_decode_date (const ISC_QUAD ISC_FAR *, 
					void ISC_FAR *);

void        ISC_EXPORT isc_decode_sql_date (const ISC_DATE ISC_FAR *, 
					void ISC_FAR *);

void        ISC_EXPORT isc_decode_sql_time (const ISC_TIME ISC_FAR *, 
					void ISC_FAR *);

void        ISC_EXPORT isc_decode_timestamp (const ISC_TIMESTAMP ISC_FAR *, 
					void ISC_FAR *);
...
void        ISC_EXPORT isc_encode_date (const void ISC_FAR *, 
					ISC_QUAD ISC_FAR *);

void        ISC_EXPORT isc_encode_sql_date (const void ISC_FAR *, 
					ISC_DATE ISC_FAR *);

void        ISC_EXPORT isc_encode_sql_time (const void ISC_FAR *, 
					ISC_TIME ISC_FAR *);

void        ISC_EXPORT isc_encode_timestamp (const void ISC_FAR *, 
...
ISC_LONG    ISC_EXPORT isc_vax_integer (const char ISC_FAR *, 
					short);

ISC_INT64   ISC_EXPORT isc_portable_integer  (const unsigned char ISC_FAR *,
                                              short);
...
int ISC_EXPORT isc_add_user (ISC_STATUS ISC_FAR *, const USER_SEC_DATA *);

int ISC_EXPORT isc_delete_user (ISC_STATUS ISC_FAR *, const USER_SEC_DATA *);

int ISC_EXPORT isc_modify_user (ISC_STATUS ISC_FAR *, const USER_SEC_DATA *);
...
ISC_LONG    ISC_EXPORT isc_ftof (const char ISC_FAR *, 
				 unsigned short, 
				 char ISC_FAR *, 
				 unsigned short);
...
#define isc_dpb_numeric_scale_reduction	  70

#ifdef EXT_SECURITY
#define isc_dpb_sec_flags	91
#define isc_dpb_sec_type	92
#define isc_dpb_sec_principal	93
#define isc_dpb_sec_srv_name	94
#endif
...
#ifdef EXT_SECURITY
#define isc_dpb_sec_delegation	1
#define isc_dpb_sec_mutual_auth	2
#define isc_dpb_sec_replay	4
#define isc_dpb_sec_sequence	8
#define isc_dpb_sec_confidentiality	16
#define isc_dpb_sec_integrity	32
#define	isc_dpb_sec_anonymous	64
#define isc_dpb_sec_transport	0x08000000	/* use transport security if supported by underlying protocol */
#endif
...
#define ISCCFG_REJECT_AMBIGUITY_KEY 24
#define ISCCFG_SQZ_BLOCK_KEY	25
#define ISCCFG_LOCK_TIMEOUT_KEY	26
#define ISCCFG_YAFFIL_ODS_KEY	27
#define ISCCFG_CONSTRAINT_INDEX_NAME_KEY	28

#ifdef SET_TCP_NO_DELAY
#define ISCCFG_NO_NAGLE_KEY	29
#endif

#ifdef WIN_NT
#define ISCCFG_WIN32_DISABLEFILECACHE_KEY 30
#define	ISCCFG_LOCKMEM_RES_KEY	31
#endif

#if defined MULTI_THREAD || defined WIN_NT
#define ISCCFG_FORCERESHEDULE_KEY 32
#endif

#define ISCCFG_LEGACY_DIALECT1_KEY	33
