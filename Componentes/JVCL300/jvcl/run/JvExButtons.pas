...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvExButtons.pas,v 1.55 2005/03/09 07:24:57 marquardt Exp $
...
function TJvExSpeedButton.BaseWndProc(Msg: Integer; WParam: Integer = 0; LParam: Integer = 0): Integer;
var
  Mesg: TMessage;
begin
  Mesg.Msg := Msg;
...
function TJvExSpeedButton.WantKey(Key: Integer; Shift: TShiftState; const KeyText: WideString): Boolean;
begin
...
procedure TJvExSpeedButton.CMSetAutoSize(var Msg: TMessage);
begin
...
function TJvExBitBtn.BaseWndProc(Msg: Integer; WParam: Integer = 0; LParam: Integer = 0): Integer;
var
  Mesg: TMessage;
begin
  Mesg.Msg := Msg;
...
function TJvExBitBtn.WantKey(Key: Integer; Shift: TShiftState; const KeyText: WideString): Boolean;
begin
  Result := BaseWndProc(CM_DIALOGCHAR, Word(Key), ShiftStateToKeyData(Shift)) <> 0;
end;
...
procedure TJvExBitBtn.CMSetAutoSize(var Msg: TMessage);
begin
  SetAutoSize(Msg.WParam <> 0);
end;
