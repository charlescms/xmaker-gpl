...
// Core functions
function zlibVersion;          external ZLibModuleName;
function deflateInit_;         external ZLibModuleName; // wrapped by deflateInit()
function deflate;              external ZLibModuleName;
function deflateEnd;           external ZLibModuleName;
function inflateInit_;         external ZLibModuleName; // wrapped by inflateInit()
function inflate;              external ZLibModuleName;
function inflateEnd;           external ZLibModuleName;
function deflateInit2_;        external ZLibModuleName; // wrapped by deflateInit2()
function deflateSetDictionary; external ZLibModuleName;
function deflateCopy;          external ZLibModuleName;
function deflateReset;         external ZLibModuleName;
function deflateParams;        external ZLibModuleName;
function deflateBound;         external ZLibModuleName;
function deflatePrime;         external ZLibModuleName;
function inflateInit2_;        external ZLibModuleName; // wrapped by inflateInit2()
function inflateSetDictionary; external ZLibModuleName;
function inflateSync;          external ZLibModuleName;
...
function zlibCompileFlags;     external ZLibModuleName;
function compress;             external ZLibModuleName;
function compress2;            external ZLibModuleName;
function compressBound;        external ZLibModuleName;
function uncompress;           external ZLibModuleName;

// Checksums
function adler32;              external ZLibModuleName;
function crc32;                external ZLibModuleName;
