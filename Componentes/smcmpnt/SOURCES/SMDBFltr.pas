...
var
  ASignStr: array[0..10] of ShortString = ('', '', '', '', '', '', '', '', '', '', '');
  ASign: array[0..10] of ShortString = ('=', '<>',
                                       '<=', '>=',
                                       '<', '>',
                                       'IS NULL', 'IS NOT NULL',
                                       'IN', '', '='{'LIKE'});
  ACondition: array[Boolean, Boolean] of ShortString = ((' OR  ', 'OR'),
                                                        (' AND ', 'AND'));
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DisposeStr(PString(Items[1].Data));
        {add a new string}
...
begin
  ...
  begin
    ...
    DisposeStr(PString(EditLI.Data));
