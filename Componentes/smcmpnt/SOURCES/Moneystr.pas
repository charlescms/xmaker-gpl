...
const FullCurrency: array[TLanguage] of array[0..10, 1..6] of string[15] =
      ((('гривн€',      'гривни',      'гривен',      'копiйка', 'копiйки',  'копiйок'),
...
function GetMoneyString(IntPart: Boolean; strValue: ShortString; Expand: TExpand; Language: TLanguage; Currency: TCurrency): string;
var
  strRevert, PP: ShortString;
