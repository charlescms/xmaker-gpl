**********************************************************************
  GREATIS OBJECT INSPECTOR AND PROPERTY INTERFACE HELP
...
9. Choose Edit | Add Files..., then locate and open again 
   your *.hlp files. This will enable context sensitive 
   help for the component.
...
:Link filename.hlp
   ...
   where filename.hlp is name of your help file (f.e. ps.hlp)
