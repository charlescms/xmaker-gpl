...
// (DO NOT EDIT: machine generated header) 'SDCSb.pas' rev: 6.00
...
public:
	...
	/* ESDEngineError.Create */ inline __fastcall ESDCSBError(int AErrorCode, int ANativeError, const AnsiString Msg, int AErrorPos) : Sdcommon::ESDEngineError(AErrorCode, ANativeError, Msg, AErrorPos) { }
	#pragma option pop
	#pragma option push -w-inl
	/* ESDEngineError.CreateDefPos */ inline __fastcall virtual ESDCSBError(int AErrorCode, int ANativeError, const AnsiString Msg) : Sdcommon::ESDEngineError(AErrorCode, ANativeError, Msg) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ESDCSBError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : Sdcommon::ESDEngineError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDCSBError(int Ident)/* overload */ : Sdcommon::ESDEngineError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall ESDCSBError(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : Sdcommon::ESDEngineError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall ESDCSBError(const AnsiString Msg, int AHelpContext) : Sdcommon::ESDEngineError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ESDCSBError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : Sdcommon::ESDEngineError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDCSBError(int Ident, int AHelpContext)/* overload */ : Sdcommon::ESDEngineError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDCSBError(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Sdcommon::ESDEngineError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
private:
	...
	AnsiString __fastcall GetConnectStr();
...
extern PACKAGE Word __stdcall (*SqlBbr)(Word Cur, SqlTXerPtr errno, void * errbuf, SqlTDalPtr buflen, SqlTBirPtr errrow, SqlTRbfPtr rbf, Word errseq);
extern PACKAGE Word __stdcall (*SqlBdb)(Word shandle, void * dbname, Word dbnamel, void * bkpdir, Word bkpdirl, Byte local, Byte over);
extern PACKAGE Word __stdcall (*SqlBef)(Word Cur);
extern PACKAGE Word __stdcall (*SqlBer)(Word Cur, SqlTRcdPtr rcd, SqlTBirPtr errrow, SqlTRbfPtr rbf, Word errseq);
...
extern PACKAGE Word __stdcall (*SqlBlf)(Word shandle, void * dbname, Word dbnamel, void * bkpdir, Word bkpdirl, Byte local, Byte over);
extern PACKAGE Word __stdcall (*SqlBlk)(Word Cur, Word blkflg);
extern PACKAGE Word __stdcall (*SqlBln)(Word Cur, Byte bnn);
extern PACKAGE Word __stdcall (*SqlBna)(Word Cur, void * bnp, Byte bnl, void * dap, Word dal, Byte sca, Byte pdt, short nli);
extern PACKAGE Word __stdcall (*SqlBnd)(Word Cur, void * bnp, Byte bnl, void * dap, Word dal, Byte sca, Byte pdt);
extern PACKAGE Word __stdcall (*SqlBnn)(Word Cur, Byte bnn, void * dap, Word dal, Byte sca, Byte pdt);
extern PACKAGE Word __stdcall (*SqlBnu)(Word Cur, Byte bnn, void * dap, Word dal, Byte sca, Byte pdt, short nli);
extern PACKAGE Word __stdcall (*SqlBss)(Word shandle, void * dbname, Word dbnamel, void * bkpdir, Word bkpdirl, Byte local, Byte over);
...
extern PACKAGE Word __stdcall (*SqlCon)(Word &Cur, void * pDbName, Word lDbname, Word CurSiz, Word Pages, Byte Recovr, Word OutSize, Word InSize);
extern PACKAGE Word __stdcall (*SqlCpy)(Word fcur, void * selp, Word sell, Word tcur, void * isrtp, Word isrtl);
...
extern PACKAGE Word __stdcall (*SqlDes)(Word cur, Byte slc, SqlTDdtPtr ddt, SqlTDdlPtr ddl, void * chp, SqlTChlPtr chlp, SqlTPrePtr prep, SqlTScaPtr scap);
...
extern PACKAGE Word __stdcall (*SqlDsc)(Word Cur, Byte slc, Byte &edt, Byte &edl, void * chp, Byte &chlp, Byte &prep, Byte &scap);
...
extern PACKAGE Word __stdcall (*SqlGsi)(Word shandle, Word infoflags, void * buffer, Word buflen, Word &rbuflen);
...
extern PACKAGE Word __stdcall (*SqlIns)(Word SrvNo, void * DbName, Word lDbName, Word CreateFlag, Word OverWrite);
...
extern PACKAGE Word __stdcall (*SqlRdb)(Word shandle, void * dbname, Word dbnamel, void * bkpdir, Word bkpdirl, Byte local, Byte over);
...
extern PACKAGE Word __stdcall (*SqlRes)(Word &Cur, void * bkfname, Word bkfnlen, Word bkfserv, Byte overwrt, void * dbname, Word dbnlen, Word dbserv);
extern PACKAGE Word __stdcall (*SqlRet)(Word Cur, void * cnp, Word cnl);
extern PACKAGE Word __stdcall (*SqlRlf)(Word shandle, void * dbname, Word dbnamel, void * bkpdir, Word bkpdirl, Byte local, Byte over);
extern PACKAGE Word __stdcall (*SqlRlo)(Word Cur, Byte slc, void * bufp, Word bufl, Word &readl);
extern PACKAGE Word __stdcall (*SqlRof)(Word shandle, void * dbname, Word dbnamel, Word mode, void * datetime, Word datetimel);
...
extern PACKAGE Word __stdcall (*SqlRss)(Word shandle, void * dbname, Word dbnamel, void * bkpdir, Word bkpdirl, Byte local, Byte over);
...
extern PACKAGE Word __stdcall (*SqlSsb)(Word Cur, Byte slc, Byte pdt, void * pbp, Byte pdl, Byte sca, SqlTCdlPtr pcv, SqlTFscPtr pfc);
...
extern PACKAGE Word __stdcall (*SqlTem)(Word Cur, SqlTXerPtr xer, Word msgtyp, void * bfp, Word bfl, SqlTDalPtr txtlen);
...
extern PACKAGE Word __stdcall (*SqlXnp)(void * Outp, Word OutL, void * isnp, Byte isnl, void * PicP, Word PicL);
