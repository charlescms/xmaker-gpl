...
// (DO NOT EDIT: machine generated header) 'SDInt.pas' rev: 6.00
...
public:
	int __stdcall (*isc_attach_database)(PISC_STATUS status_vector, short db_name_length, char * db_name, PISC_DB_HANDLE db_handle, short parm_buffer_length, char * parm_buffer);
	void __stdcall (*isc_blob_default_desc)(PISC_BLOB_DESC desc, char * table_name, char * column_name);
	int __stdcall (*isc_blob_gen_bpb)(PISC_STATUS status_vector, PISC_BLOB_DESC to_desc, PISC_BLOB_DESC from_desc, Word bpb_buffer_length, char * bpb_buffer, PUShort bpb_length);
	int __stdcall (*isc_blob_info)(PISC_STATUS status_vector, void * &blob_handle, short item_list_buffer_length, char * item_list_buffer, short result_buffer_length, char * result_buffer);
	int __stdcall (*isc_blob_lookup_desc)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_TR_HANDLE trans_handle, char * table_name, char * column_name, PISC_BLOB_DESC desc, char * global_column_name);
	int __stdcall (*isc_blob_set_desc)(PISC_STATUS status_vector, char * table_name, char * column_name, short subtype, short charset, short segment_size, PISC_BLOB_DESC desc);
	...
	int __stdcall (*isc_create_blob)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_TR_HANDLE tran_handle, void * &blob_handle, PISC_QUAD blob_id);
	int __stdcall (*isc_create_blob2)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_TR_HANDLE tran_handle, void * &blob_handle, PISC_QUAD blob_id, short bpb_length, char * bpb_address);
	int __stdcall (*isc_create_database)(PISC_STATUS status_vector, short db_name_length, char * db_name, PISC_DB_HANDLE db_handle, short parm_buffer_length, char * parm_buffer, short parm_7);
	int __stdcall (*isc_database_info)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, short item_list_buffer_length, char * item_list_buffer, short result_buffer_length, char * result_buffer);
	...
	int __stdcall (*isc_dsql_allocate_statement)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_STMT_HANDLE stmt_handle);
	int __stdcall (*isc_dsql_alloc_statement2)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_STMT_HANDLE stmt_handle);
	int __stdcall (*isc_dsql_describe)(PISC_STATUS status_vector, PISC_STMT_HANDLE stmt_handle, Word dialect, PXSQLDA xsqlda);
	int __stdcall (*isc_dsql_describe_bind)(PISC_STATUS status_vector, PISC_STMT_HANDLE stmt_handle, Word dialect, PXSQLDA xsqlda);
	int __stdcall (*isc_dsql_execute)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle, PISC_STMT_HANDLE stmt_handle, Word dialect, PXSQLDA xsqlda);
	int __stdcall (*isc_dsql_execute2)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle, PISC_STMT_HANDLE stmt_handle, Word dialect, PXSQLDA in_xsqlda, PXSQLDA out_xsqlda);
	int __stdcall (*isc_dsql_execute_immediate)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_TR_HANDLE tran_handle, Word length, char * statement, Word dialect, PXSQLDA xsqlda);
	int __stdcall (*isc_dsql_exec_immed2)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_TR_HANDLE tran_handle, Word length, char * statement, Word dialect, PXSQLDA in_xsqlda, PXSQLDA out_xsqlda);
	int __stdcall (*isc_dsql_fetch)(PISC_STATUS status_vector, PISC_STMT_HANDLE stmt_handle, Word dialect, PXSQLDA xsqlda);
	int __stdcall (*isc_dsql_finish)(PISC_DB_HANDLE db_handle);
	int __stdcall (*isc_dsql_free_statement)(PISC_STATUS status_vector, PISC_STMT_HANDLE stmt_handle, Word option);
	int __stdcall (*isc_dsql_prepare)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle, PISC_STMT_HANDLE stmt_handle, Word length, char * statement, Word dialect, PXSQLDA xsqlda);
	int __stdcall (*isc_dsql_set_cursor_name)(PISC_STATUS status_vector, PISC_STMT_HANDLE stmt_handle, char * cursor_name, Word type_reserved);
	int __stdcall (*isc_dsql_sql_info)(PISC_STATUS status_vector, PISC_STMT_HANDLE stmt_handle, short item_length, char * items, short buffer_length, char * buffer);
	...
	void __stdcall (*isc_event_counts)(PISC_STATUS status_vector, short buffer_length, char * event_buffer, char * result_buffer);
	int __stdcall (*isc_get_segment)(PISC_STATUS status_vector, void * &blob_handle, Word &actual_seg_length, Word seg_buffer_length, char * seg_buffer);
	int __stdcall (*isc_interprete)(char * buffer, PISC_STATUS &status_vector);
	int __stdcall (*isc_open_blob)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_TR_HANDLE tran_handle, void * &blob_handle, PISC_QUAD blob_id);
	int __stdcall (*isc_open_blob2)(PISC_STATUS status_vector, PISC_DB_HANDLE db_handle, PISC_TR_HANDLE tran_handle, void * &blob_handle, const TGDS_QUAD blob_id, short bpb_length, char * bpb_buffer);
	int __stdcall (*isc_prepare_transaction)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle);
	int __stdcall (*isc_prepare_transaction2)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle, short msg_length, char * msg);
	...
	int __stdcall (*isc_put_segment)(PISC_STATUS status_vector, void * &blob_handle, Word seg_buffer_len, char * seg_buffer);
	...
	int __stdcall (*isc_start_multiple)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle, short db_handle_count, TISC_TEB &teb_vector_address);
	int __cdecl (*isc_start_transaction)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle, short db_handle_count, PISC_DB_HANDLE db_handle, int tpb_length, char * tpb_address);
	...
	int __stdcall (*isc_transaction_info)(PISC_STATUS status_vector, PISC_TR_HANDLE tran_handle, short item_list_buffer_length, char * item_list_buffer, short result_buffer_length, char * result_buffer);
...
public:
	#pragma option push -w-inl
	/* ESDEngineError.Create */ inline __fastcall ESDIntError(int AErrorCode, int ANativeError, const AnsiString Msg, int AErrorPos) : Sdcommon::ESDEngineError(AErrorCode, ANativeError, Msg, AErrorPos) { }
	#pragma option pop
	#pragma option push -w-inl
	/* ESDEngineError.CreateDefPos */ inline __fastcall virtual ESDIntError(int AErrorCode, int ANativeError, const AnsiString Msg) : Sdcommon::ESDEngineError(AErrorCode, ANativeError, Msg) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ESDIntError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : Sdcommon::ESDEngineError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDIntError(int Ident)/* overload */ : Sdcommon::ESDEngineError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall ESDIntError(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : Sdcommon::ESDEngineError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall ESDIntError(const AnsiString Msg, int AHelpContext) : Sdcommon::ESDEngineError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ESDIntError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : Sdcommon::ESDEngineError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDIntError(int Ident, int AHelpContext)/* overload */ : Sdcommon::ESDEngineError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDIntError(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Sdcommon::ESDEngineError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TICustomIntDatabase.Create */ inline __fastcall virtual TIIntDatabase(Classes::TStrings* ADbParams) : TICustomIntDatabase(ADbParams) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TICustomIntCommand.Create */ inline __fastcall virtual TIIntCommand(Sdcommon::TISqlDatabase* ASqlDatabase) : TICustomIntCommand(ASqlDatabase) { }
	#pragma option pop
	#pragma option push -w-inl
...
extern PACKAGE void __fastcall IntCheck(int Status, PISC_STATUS &StatusVector, TMetaClass* AErrorClass, TIntFunctions* ApiCalls);
