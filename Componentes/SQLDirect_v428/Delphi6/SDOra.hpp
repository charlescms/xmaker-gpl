...
extern PACKAGE int __cdecl (*OCITypeArrayByName)(void * &hEnv, void * &hError, const POCISvcCtx phSvc, int array_len, const PPChar arr_schema_name, ub4p arr_s_length, const PPChar arr_type_name, ub4p arr_t_length, const PPChar arr_version_name, ub4p arr_v_length, Word pin_duration, int get_option, POCIType arr_tdo);
extern PACKAGE int __cdecl (*OCITypeArrayByRef)(void * &hEnv, void * &hError, int array_len, const POCIRef arr_type_ref, Word pin_duration, int get_option, POCIType arr_tdo);
extern PACKAGE int __cdecl (*OCIInitialize)(int mode, Pdvoid ctxp, Tmalocfp malocfp, Tralocfp ralocfp, Tmfreefp mfreefp);
extern PACKAGE int __cdecl (*OCITerminate)(int mode);
extern PACKAGE int __cdecl (*OCIHandleAlloc)(const Pdvoid phParenEnv, Pdvoid &hndlp, int htype, int xtramem_sz, PPdvoid usrmemp);
extern PACKAGE int __cdecl (*OCIHandleFree)(Pdvoid hndlp, int htype);
extern PACKAGE int __cdecl (*OCIDescriptorAlloc)(const Pdvoid phParenEnv, Pdvoid &descp, int htype, int xtramem_sz, PPdvoid usrmemp);
extern PACKAGE int __cdecl (*OCIDescriptorFree)(Pdvoid descp, int htype);
extern PACKAGE int __cdecl (*OCIEnvCreate)(POCIEnv &phEnv, int mode, Pdvoid ctxp, Tmalocfp malocfp, Tralocfp ralocfp, Tmfreefp mfreefp, int xtramem_sz, Pdvoid usrmemp);
extern PACKAGE int __cdecl (*OCIEnvInit)(POCIEnv &phEnv, int mode, int xtramem_sz, Pdvoid usrmemp);
extern PACKAGE int __cdecl (*OCIServerAttach)(POCIServer phSrv, POCIError phError, const char * dblink, int dblink_len, int mode);
extern PACKAGE int __cdecl (*OCIServerDetach)(POCIServer phSrv, POCIError phError, int mode);
extern PACKAGE int __cdecl (*OCISessionBegin)(POCISvcCtx phSvc, POCIError phError, POCISession phUsr, int credt, int mode);
extern PACKAGE int __cdecl (*OCISessionEnd)(POCISvcCtx phSvc, POCIError phError, POCISession phUsr, int mode);
extern PACKAGE int __cdecl (*OCILogon)(POCIEnv phEnv, POCIError phError, POCISvcCtx &svchp, const char * username, int uname_len, const char * password, int passwd_len, const char * dbname, int dbname_len);
extern PACKAGE int __cdecl (*OCILogoff)(POCISvcCtx phSvc, POCIError phError);
extern PACKAGE int __cdecl (*OCIPasswordChange)(POCISvcCtx phSvc, POCIError phError, const char * user_name, int usernm_len, const char * opasswd, int opasswd_len, const char * npasswd, int npasswd_len, int mode);
extern PACKAGE int __cdecl (*OCIStmtPrepare)(POCIStmt phStmt, POCIError phError, const char * stmt, int stmt_len, int language, int mode);
extern PACKAGE int __cdecl (*OCIBindByPos)(POCIStmt phStmt, POCIBind &phBind, POCIError phError, int position, Pdvoid valuep, int value_sz, Word dty, Pdvoid indp, ub2p alenp, ub2p rcodep, int maxarr_len, ub4p curelep, int mode);
extern PACKAGE int __cdecl (*OCIBindByName)(POCIStmt phStmt, POCIBind &phBind, POCIError phError, const char * placeholder, int placeh_len, Pdvoid valuep, int value_sz, Word dty, Pdvoid indp, ub2p alenp, ub2p rcodep, int maxarr_len, ub4p curelep, int mode);
extern PACKAGE int __cdecl (*OCIBindObject)(POCIBind phBind, POCIError phError, const POCIType otype, Pdvoid &pgvp, int pvszsp, Pdvoid &indp, ub4p indszp);
extern PACKAGE int __cdecl (*OCIBindDynamic)(POCIBind phBind, POCIError phError, Pdvoid ictxp, TOCICallbackInBind icbfp, Pdvoid octxp, TOCICallbackOutBind ocbfp);
extern PACKAGE int __cdecl (*OCIBindArrayOfStruct)(POCIBind phBind, POCIError phError, int pvskip, int indskip, int alskip, int rcskip);
extern PACKAGE int __cdecl (*OCIStmtGetPieceInfo)(POCIStmt phStmt, POCIError phError, Pdvoid &hndlp, int &htype, Byte &in_out, int &iter, int &idx, Byte &piece);
extern PACKAGE int __cdecl (*OCIStmtSetPieceInfo)(Pdvoid hndlp, int HandleType, POCIError phError, const void * bufp, int &alen, Byte piece, short &ind, ub2p rcodep);
extern PACKAGE int __cdecl (*OCIStmtExecute)(POCISvcCtx phSvc, POCIStmt phStmt, POCIError phError, int iters, int rowoff, const POCISnapshot snap_in, POCISnapshot snap_out, int mode);
extern PACKAGE int __cdecl (*OCIDefineByPos)(POCIStmt phStmt, POCIDefine &phDefine, POCIError phError, int position, void * pValue, int value_sz, Word dty, Pdvoid indp, ub2p rlenp, ub2p rcodep, int mode);
extern PACKAGE int __cdecl (*OCIDefineObject)(POCIDefine phDefine, POCIError phError, const POCIType phType, Pdvoid &pgvp, ub4p pvszsp, Pdvoid &indp, ub4p indszp);
extern PACKAGE int __cdecl (*OCIDefineDynamic)(POCIDefine phDefine, POCIError phError, Pdvoid octxp, TOCICallbackDefine ocbfp);
extern PACKAGE int __cdecl (*OCIDefineArrayOfStruct)(POCIDefine phDefine, POCIError phError, int pvskip, int indskip, int rlskip, int rcskip);
extern PACKAGE int __cdecl (*OCIStmtFetch)(POCIStmt phStmt, POCIError phError, int nrows, Word orientation, int mode);
extern PACKAGE int __cdecl (*OCIStmtGetBindInfo)(POCIStmt phStmt, POCIError phError, int size, int startloc, sb4p found, PPChar arr_bvn, ub1p arr_bvnl, PPChar arr_inv, ub1p arr_inpl, ub1p arr_dupl, PPOCIBind arr_hndl);
extern PACKAGE int __cdecl (*OCIDescribeAny)(POCISvcCtx phSvc, POCIError phError, Pdvoid objptr, int objnm_len, Byte objptr_typ, Byte info_level, Byte objtyp, POCIDescribe phDsc);
extern PACKAGE int __cdecl (*OCIParamGet)(const Pdvoid pHndl, int htype, POCIError phError, Pdvoid &pParmd, int pos);
extern PACKAGE int __cdecl (*OCIParamSet)(Pdvoid pHdl, int htyp, POCIError phError, const Pdvoid pDsc, int dtyp, int pos);
...
extern PACKAGE int __cdecl (*OCIErrorGet)(Pdvoid pHndl, int RecordNo, char * SqlState, int &ErrCode, char * buf, int bufsiz, int typ);
extern PACKAGE int __cdecl (*OCILobAppend)(POCISvcCtx phSvc, POCIError phError, POCILobLocator dst_locp, POCILobLocator src_locp);
extern PACKAGE int __cdecl (*OCILobAssign)(POCIEnv phEnv, POCIError phError, const POCILobLocator src_locp, POCILobLocator &dst_locp);
extern PACKAGE int __cdecl (*OCILobCharSetForm)(POCIEnv phEnv, POCIError phError, const POCILobLocator locp, ub1p csfrm);
extern PACKAGE int __cdecl (*OCILobCharSetId)(POCIEnv phEnv, POCIError phError, const POCILobLocator locp, ub2p csid);
extern PACKAGE int __cdecl (*OCILobCopy)(POCISvcCtx phSvc, POCIError phError, void * dst_locp, void * src_locp, int amount, int dst_offset, int src_offset);
extern PACKAGE int __cdecl (*OCILobCreateTemporary)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp, Word csid, Byte csfrm, Byte lobtype, BOOL cache, Word duration);
extern PACKAGE int __cdecl (*OCILobDisableBuffering)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp);
extern PACKAGE int __cdecl (*OCILobEnableBuffering)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp);
extern PACKAGE int __cdecl (*OCILobErase)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp, ub4p amount, int offset);
...
extern PACKAGE int __cdecl (*OCILobFileExists)(POCISvcCtx phSvc, POCIError phError, POCILobLocator filep, BOOL &flag);
extern PACKAGE int __cdecl (*OCILobFileGetName)(POCIEnv phEnv, POCIError phError, const POCILobLocator filep, char * dir_alias, ub2p d_length, char * filename, ub2p f_length);
extern PACKAGE int __cdecl (*OCILobFileIsOpen)(POCISvcCtx phSvc, POCIError phError, POCILobLocator filep, BOOL &flag);
extern PACKAGE int __cdecl (*OCILobFileOpen)(POCISvcCtx phSvc, POCIError phError, POCILobLocator filep, Byte mode);
extern PACKAGE int __cdecl (*OCILobFileSetName)(POCIEnv phEnv, POCIError phError, POCILobLocator &filep, const char * dir_alias, Word d_length, const char * filename, Word f_length);
extern PACKAGE int __cdecl (*OCILobFlushBuffer)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp, int flag);
extern PACKAGE int __cdecl (*OCILobFreeTemporary)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp);
extern PACKAGE int __cdecl (*OCILobGetLength)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp, int &len);
extern PACKAGE int __cdecl (*OCILobIsEqual)(POCIEnv phEnv, const POCILobLocator x, const POCILobLocator y, BOOL &is_equal);
extern PACKAGE int __cdecl (*OCILobLoadFromFile)(POCISvcCtx phSvc, POCIError phError, POCILobLocator dst_locp, POCILobLocator src_filep, int amount, int dst_offset, int src_offset);
extern PACKAGE int __cdecl (*OCILobLocatorIsInit)(POCIEnv phEnv, POCIError phError, const POCILobLocator locp, BOOL &is_initialized);
extern PACKAGE int __cdecl (*OCILobRead)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp, int &amt, int offset, void * bufp, int bufl, Pdvoid ctxp, TCBLobRead cbfp, Word csid, Byte csfrm);
extern PACKAGE int __cdecl (*OCILobTrim)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp, int newlen);
extern PACKAGE int __cdecl (*OCILobWrite)(POCISvcCtx phSvc, POCIError phError, POCILobLocator locp, int &amt, int offset, void * bufp, int buflen, Byte piece, Pdvoid ctxp, TCBLobWrite cbfp, Word csid, Byte csfrm);
extern PACKAGE int __cdecl (*OCIBreak)(Pdvoid pHndl, POCIError phError);
extern PACKAGE int __cdecl (*OCIServerVersion)(Pdvoid pHndl, POCIError phError, char * buf, int bufsz, Byte hndltype);
extern PACKAGE int __cdecl (*OCIAttrGet)(const Pdvoid trgthndlp, int trghndltyp, void * attributep, ub4p sizep, int attrtype, POCIError phError);
extern PACKAGE int __cdecl (*OCIAttrSet)(Pdvoid trgthndlp, int trghndltyp, void * attributep, int size, int attrtype, POCIError phError);
...
extern PACKAGE int __cdecl (*OCIDateTimeConstruct)(Pdvoid pHndl, POCIError phError, POCIDateTime datetime, short year, Byte month, Byte day, Byte hour, Byte min, Byte sec, int fsec, char * timezone, int timezone_length);
extern PACKAGE int __cdecl (*OCIDateTimeGetDate)(Pdvoid pHndl, POCIError phError, POCIDateTime date, short &year, Byte &month, Byte &day);
extern PACKAGE int __cdecl (*OCIDateTimeGetTime)(Pdvoid pHndl, POCIError phError, POCIDateTime datetime, Byte &hour, Byte &minute, Byte &sec, int &fsec);
extern PACKAGE int __cdecl (*OCIDateTimeGetTimeZoneName)(Pdvoid pHndl, POCIError phError, POCIDateTime datetime, ub1p buf, ub4p buflen);
extern PACKAGE int __cdecl (*OCIDateTimeGetTimeZoneOffset)(Pdvoid pHndl, POCIError phError, POCIDateTime datetime, Shortint &hour, Shortint &minute);
extern PACKAGE int __cdecl (*OCIIntervalSetYearMonth)(Pdvoid pHndl, POCIError phError, int yr, int mnth, POCIInterval result);
extern PACKAGE int __cdecl (*OCIIntervalGetYearMonth)(Pdvoid pHndl, POCIError phError, int &yr, int &mnth, const POCIInterval result);
extern PACKAGE int __cdecl (*OCIIntervalSetDaySecond)(Pdvoid pHndl, POCIError phError, int dy, int hr, int mm, int ss, int fsec, POCIInterval result);
extern PACKAGE int __cdecl (*OCIIntervalGetDaySecond)(Pdvoid pHndl, POCIError phError, int &dy, int &hr, int &mm, int &ss, int &fsec, const POCIInterval result);
