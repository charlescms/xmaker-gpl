...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDMySQLError(int Ident, Extended Dummy) : Sdcommon::ESDEngineError(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDMySQLError(int Ident, int AHelpContext) : Sdcommon::ESDEngineError(
		Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDMySQLError(int Ident, const System::TVarRec * 
...
private:
	...
	System::Comp FRowsAffected;
	System::Comp FAutoIncID;
...
extern PACKAGE System::Comp __stdcall (*mysql_num_rows)(void * res);
...
extern PACKAGE System::Comp __stdcall (*mysql_affected_rows)(void * mysql);
extern PACKAGE System::Comp __stdcall (*mysql_insert_id)(void * mysql);
...
extern PACKAGE void __stdcall (*mysql_data_seek)(void * res, System::Comp offset);
