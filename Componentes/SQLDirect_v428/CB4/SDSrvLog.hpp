...
// (DO NOT EDIT: machine generated header) 'SDSrvLog.pas' rev: 4.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TSDSrvLoginDlg(Classes::TComponent* AOwner) : Forms::TForm(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TSDSrvLoginDlg(Classes::TComponent* AOwner, int 
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TSDSrvLoginDlg(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
