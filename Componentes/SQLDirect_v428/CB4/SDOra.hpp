...
// (DO NOT EDIT: machine generated header) 'SDOra.pas' rev: 4.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDOraError(int Ident, Extended Dummy) : Sdcommon::ESDEngineError(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDOraError(int Ident, int AHelpContext) : Sdcommon::ESDEngineError(
		Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDOraError(int Ident, const System::TVarRec * Args
