...
// (DO NOT EDIT: machine generated header) 'SDFib.pas' rev: 5.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDFibError(int Ident)/* overload */ : Sdint::ESDIntError(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall ESDFibError(int Ident, const System::TVarRec * Args, 
		const int Args_Size)/* overload */ : Sdint::ESDIntError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDFibError(int Ident, int AHelpContext)/* overload */
		 : Sdint::ESDIntError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDFibError(System::PResStringRec ResStringRec, 
		const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Sdint::ESDIntError(
