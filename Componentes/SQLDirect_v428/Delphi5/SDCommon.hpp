...
// (DO NOT EDIT: machine generated header) 'SDCommon.pas' rev: 5.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDSqlLibError(int Ident)/* overload */ : Db::EDatabaseError(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDSqlLibError(int Ident, int AHelpContext)/* overload */
		 : Db::EDatabaseError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDSqlLibError(System::PResStringRec ResStringRec
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDEngineError(int Ident)/* overload */ : Db::EDatabaseError(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDEngineError(int Ident, int AHelpContext)/* overload */
		 : Db::EDatabaseError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDEngineError(System::PResStringRec ResStringRec
		, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Db::EDatabaseError(
		ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	__fastcall TSDExprParser(Db::TDataSet* DataSet, const AnsiString Text, Db::TFilterOptions Options, 
		Dbcommon::TParserOptions ParserOptions, const AnsiString FieldName, Classes::TBits* DepFields, const 
		Byte * FieldMap);
	__fastcall virtual ~TSDExprParser(void);
	bool __fastcall CalcBooleanValue(void);
	Variant __fastcall CalcVariantValue(void);
