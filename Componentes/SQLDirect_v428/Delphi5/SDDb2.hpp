...
// (DO NOT EDIT: machine generated header) 'SDDb2.pas' rev: 5.00
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ESDDb2Error(int Ident)/* overload */ : Sdodbc::ESDOdbcError(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ESDDb2Error(int Ident, int AHelpContext)/* overload */
		 : Sdodbc::ESDOdbcError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ESDDb2Error(System::PResStringRec ResStringRec, 
...
public:
	#pragma option push -w-inl
	/* TICustomOdbcDatabase.Create */ inline __fastcall virtual TIDB2Database(Classes::TStrings* ADbParams
...
public:
	#pragma option push -w-inl
	/* TICustomOdbcCommand.Create */ inline __fastcall virtual TIDB2Command(Sdcommon::TISqlDatabase* ASqlDatabase
