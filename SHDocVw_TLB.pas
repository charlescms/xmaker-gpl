...
// File generated on 18/10/2006 08:33:21 from Type Library described below.
...
// *********************************************************************//
  ...
  SearchAssistantOC = ISearchAssistantOC3;
...
// create instances of the default interface ISearchAssistantOC3 exposed by              
...
// *********************************************************************//
// The Class CoShellSearchAssistantOC provides a Create and CreateRemote method to          
// create instances of the default interface ISearchAssistantOC3 exposed by              
// the CoClass ShellSearchAssistantOC. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoShellSearchAssistantOC = class
    class function Create: ISearchAssistantOC3;
    class function CreateRemote(const MachineName: string): ISearchAssistantOC3;
  end;
...
class function CoSearchAssistantOC.Create: ISearchAssistantOC3;
begin
  Result := CreateComObject(CLASS_SearchAssistantOC) as ISearchAssistantOC3;
end;

class function CoSearchAssistantOC.CreateRemote(const MachineName: string): ISearchAssistantOC3;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_SearchAssistantOC) as ISearchAssistantOC3;
end;

class function CoShellSearchAssistantOC.Create: ISearchAssistantOC3;
begin
  Result := CreateComObject(CLASS_ShellSearchAssistantOC) as ISearchAssistantOC3;
end;

class function CoShellSearchAssistantOC.CreateRemote(const MachineName: string): ISearchAssistantOC3;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ShellSearchAssistantOC) as ISearchAssistantOC3;
end;
