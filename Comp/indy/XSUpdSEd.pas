...
type
  TXSQLUpdateSqlEditForm = class(TForm)
  ...
  public
    ...
    property UpdateSQL: TXSQLUpdateSql read FUpdateSQL write FUpdateSQL;
  end;

var
  XSQLUpdateSqlEditForm: TXSQLUpdateSqlEditForm;

function EditUpdateSQL(AUpdateSQL: TXSQLUpdateSql): Boolean;
...
function EditUpdateSQL(AUpdateSQL: TXSQLUpdateSql): Boolean;
var
  Dlg: TXSQLUpdateSqlEditForm;
  sCaption: string;
begin
  Result := False;
  sCaption := '';
  Dlg := TXSQLUpdateSqlEditForm.Create(Application);
  try
...
{ TXSQLUpdateSqlEditForm }
procedure TXSQLUpdateSqlEditForm.InitProperties;
begin
  LoadDefaultOptions;
  SelectAllFields;
...
procedure TXSQLUpdateSqlEditForm.LoadDefaultOptions;
var
  SaveCursor: TCursor;
  i: Integer;
  q: TXSQLQuery;
begin
  if FUpdateSQL.DataSet = nil then
    Exit;
  if not(FUpdateSQL.DataSet is TXSQLQuery) then
    Exit;

  q := TXSQLQuery(FUpdateSQL.DataSet);
...
procedure TXSQLUpdateSqlEditForm.LoadStatements;
begin
...
procedure TXSQLUpdateSqlEditForm.SaveStatements;
begin
...
procedure TXSQLUpdateSqlEditForm.SelectAllFields;
begin
...
procedure TXSQLUpdateSqlEditForm.SetSelectedAllItems(lb: TListBox; State: Boolean);
var
  i: Integer;
begin
...
function TXSQLUpdateSqlEditForm.FindFieldAlias(const TableName, FieldName: string): string;
var
  i, j: Integer;
...
procedure TXSQLUpdateSqlEditForm.GenerateModifySQL;
const
  UpdateClause	= 'update ';
  SetClause	= 'set';
  WhereClause	= 'where';
...
procedure TXSQLUpdateSqlEditForm.GenerateRefreshSQL;
const
  SelectClause	= 'select ';
  FromClause	= 'from ';
  WhereClause	= 'where';
...
procedure TXSQLUpdateSqlEditForm.GenerateInsertSQL;
const
...
procedure TXSQLUpdateSqlEditForm.GenerateDeleteSQL;
const
...
procedure TXSQLUpdateSqlEditForm.FormCreate(Sender: TObject);
begin
...
procedure TXSQLUpdateSqlEditForm.FormDestroy(Sender: TObject);
begin
  FFieldInfo.Free;
  FTableInfo.Free;
...
procedure TXSQLUpdateSqlEditForm.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TXSQLUpdateSqlEditForm.cbTableNameChange(Sender: TObject);
var
...
procedure TXSQLUpdateSqlEditForm.TableNameChanged(Sender: TObject);
begin
...
procedure TXSQLUpdateSqlEditForm.GetTableFieldsClick(Sender: TObject);
...
procedure TXSQLUpdateSqlEditForm.DataSetDefaultsClick(Sender: TObject);
var
  i: Integer;
begin
  lbKeyFields.Clear;
...
procedure TXSQLUpdateSqlEditForm.GenerateSQLClick(Sender: TObject);
begin
...
procedure TXSQLUpdateSqlEditForm.SelectAllClick(Sender: TObject);
begin
...
procedure TXSQLUpdateSqlEditForm.ClearAllClick(Sender: TObject);
begin
  if pmFields.PopupComponent = lbKeyFields then
...
procedure TXSQLUpdateSqlEditForm.StatementTypeClick(Sender: TObject);
begin
...
procedure TXSQLUpdateSqlEditForm.SQLTextExit(Sender: TObject);
begin
  case rgrStatementType.ItemIndex of
...
function TXSQLUpdateSqlEditForm.QuoteName(const AIdentName: string): string;
begin
  Result := AIdentName;
...
procedure TXSQLUpdateSqlEditForm.btSelectPrimKeysClick(Sender: TObject);
var
  ids: TDataSet;
  db: TXSQLDatabase;
