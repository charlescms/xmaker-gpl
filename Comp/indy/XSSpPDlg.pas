...
type
  TXSQLStoredProcParamDlg = class(TForm)
...
var
  XSQLStoredProcParamDlg: TXSQLStoredProcParamDlg;

function EditStoredProcParams(StoredProc: TXSQLStoredProc; AList: TSDHelperParams): Boolean;
...
function EditStoredProcParams(StoredProc: TXSQLStoredProc; AList: TSDHelperParams): Boolean;
var
  Dlg: TXSQLStoredProcParamDlg;
begin
  Result := False;
  Dlg := TXSQLStoredProcParamDlg.Create(Application);
  try
...
{ TSDSPParamDlg }
procedure TXSQLStoredProcParamDlg.CheckParamCount;
begin
...
procedure TXSQLStoredProcParamDlg.CheckParamType(AParamType: TSDHelperParamType);
begin
...
procedure TXSQLStoredProcParamDlg.LoadParamType;
var
  i: Integer;
begin
...
procedure TXSQLStoredProcParamDlg.LoadParamDataType;
var
  i, Ind: Integer;
  s: string;
begin
...
procedure TXSQLStoredProcParamDlg.SetParams(AParams: TSDHelperParams);
var
  i: Integer;
begin
...
procedure TXSQLStoredProcParamDlg.SetParamDescAvailable(Value: Boolean);
begin
...
procedure TXSQLStoredProcParamDlg.FormCreate(Sender: TObject);
begin
  CheckParamCount;
...
procedure TXSQLStoredProcParamDlg.ParamNameClick(Sender: TObject);
var
  s: string;
  Idx: Integer;
begin
...
procedure TXSQLStoredProcParamDlg.ParamTypeChange(Sender: TObject);
begin
...
procedure TXSQLStoredProcParamDlg.ParamDataTypeChange(Sender: TObject);
begin
  edParamValue.Clear;
end;

procedure TXSQLStoredProcParamDlg.ParamDataTypeExit(Sender: TObject);
begin
...
procedure TXSQLStoredProcParamDlg.ParamValueExit(Sender: TObject);
var
  V: Variant;
  vtype: Integer;
begin
...
procedure TXSQLStoredProcParamDlg.NullValueChanged(Sender: TObject);
begin
...
procedure TXSQLStoredProcParamDlg.AddParamClick(Sender: TObject);
var
  sParamName: string;
begin
...
procedure TXSQLStoredProcParamDlg.DeleteParamClick(Sender: TObject);
var
  p: TSDHelperParam;
  Idx: Integer;
begin
...
procedure TXSQLStoredProcParamDlg.ParamsClearClick(Sender: TObject);
begin
  FParams.Clear;
