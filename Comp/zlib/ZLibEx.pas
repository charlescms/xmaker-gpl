...
{$endif}
  ...
  TCompressionLevel = (zclNone {equal to old's clNone}, clFastest, clDefault, clMax);
...
function  ZCompressStr(const s: AnsiString;
  level: TZCompressionLevel = zcDefault): RawByteString; overload;
...
// **: Add overload to take old enum type
function  ZCompressStrEx(const s: AnsiString;
  level: TCompressionLevel = zclNone): AnsiString; overload;
...
// **: Add overload to take old enum type
procedure ZCompressStream(inStream, outStream: TStream;
  level: TCompressionLevel = zclNone); overload;
...
function  ZCompressStrEx(const s: AnsiString;
  level: TCompressionLevel): AnsiString;
begin
