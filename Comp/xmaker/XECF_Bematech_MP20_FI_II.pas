{
   Programa.: XECF_Bematech_MP20_FI_II.Pas
   Copyright: X-Maker
            : Todos os direitos reservados
   Site.....: http://www.xmaker.com.br
}
unit XECF_Bematech_MP20_FI_II;
...
type
  TECF_Bematech_MP20_FI_II = class(TComandos)
  private
...
function TECF_Bematech_MP20_FI_II.BCD2Float(s: string): Currency;
var
  i: integer;
begin
  Result := 0;
...
function TECF_Bematech_MP20_FI_II.BCD2Inteiro(s: string): Integer;
var
  i: Integer;
begin
  Result := 0;
...
function TECF_Bematech_MP20_FI_II.BCD2Date(s: string): TDateTime;
begin
  Result := 0.0;
  try
    if Length(s) >= 3 then
...
function TECF_Bematech_MP20_FI_II.MontarComando(xComando: string): string;
var
  i, Calc, Tam: Integer;
begin
  if xComando = '' then
...
function TECF_Bematech_MP20_FI_II.Executa_Comando(xComando: string; TamanhoRetorno: Integer = 0): Boolean;
const
...
function TECF_Bematech_MP20_FI_II.GetLigada: Boolean;
begin
  Result := PortaSerial.CTS;
end;

function TECF_Bematech_MP20_FI_II.Estado: TEstado;
var
  b: byte;
...
function TECF_Bematech_MP20_FI_II.Em_Horario_Verao: Boolean;
var
  b: byte;
begin
  Executa_Comando(#$23#$11, 1);
...
function TECF_Bematech_MP20_FI_II.CNPJ: String;
begin
  Executa_Comando(#35#02, 33);
  Result := Copy(UltimaResposta, 0, 18);
end;

function TECF_Bematech_MP20_FI_II.Inscricao_Estadual: String;
begin
  Executa_Comando(#35#02, 33);
  Result := Copy(UltimaResposta, 19, 15);
end;

function TECF_Bematech_MP20_FI_II.Numero_Serie: String;
begin
  Executa_Comando(#35#00, 15);
  Result := Trim(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Numero_Cupom: Integer;
begin
  Executa_Comando(#30, 3);
  Result := BCD2Inteiro(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Numero_Ultimo_Cupom: Integer;
begin
  Executa_Comando(#30, 3);
  Result := BCD2Inteiro(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Numero_Caixa: Integer;
begin
  Executa_Comando(#35#14, 2);
  Result := BCD2Inteiro(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Numero_Loja: Integer;
begin
  Executa_Comando(#35#15, 2);
  Result := BCD2Inteiro(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Data_Atual: TDateTime;
begin
  Executa_Comando(#35#23, 6);
  Result := BCD2Date(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Data_Fiscal: TDateTime;
begin
  Executa_Comando(#35#26, 6);
  Result := BCD2Date(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Contador_Reducoes: integer;
begin
  Executa_Comando(#35#09, 2);
  Result := BCD2Inteiro(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Numero_Cancelamentos: Integer;
begin
  result := 0;
...
function TECF_Bematech_MP20_FI_II.Total_Cancelamentos: Currency;
begin
  Executa_Comando(#35#04, 7);
  Result := BCD2Float(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Total_Descontos: Currency;
begin
  Executa_Comando(#35#05, 7);
  Result := BCD2Float(UltimaResposta);
end;

function TECF_Bematech_MP20_FI_II.Abrir_Dia: Boolean;
begin
  Result := Executa_Comando(#$06);
end;

function TECF_Bematech_MP20_FI_II.Abrir_Venda: Boolean;
begin
  Result := Executa_Comando(#$00 + LFill(CNPJ_CPF, ' ', 28));
end;

function TECF_Bematech_MP20_FI_II.Vender_Item: Boolean;
begin
  Result := True;
...
function TECF_Bematech_MP20_FI_II.Cancelar_Item: Boolean;
begin
  Result := Executa_Comando(#31 + FormatFloat('0000', Item.Sequencia));
end;

function TECF_Bematech_MP20_FI_II.Imp_Acrescimo_Desconto: Boolean;
begin
...
function TECF_Bematech_MP20_FI_II.Forma_Pagto(xDescricao: String; xValor: Currency): Boolean;
var
...
function TECF_Bematech_MP20_FI_II.Fechar_Venda: Boolean;
begin
  Result := Executa_Comando(#34 + Rodape_1 + Rodape_2 + Rodape_3 + Rodape_4);
end;

function TECF_Bematech_MP20_FI_II.Cancelar_Venda: Boolean;
begin
  Result := Executa_Comando(#$0E);
end;

function TECF_Bematech_MP20_FI_II.LeituraX(xOperador: String):Boolean;
begin
...
function TECF_Bematech_MP20_FI_II.ReducaoZ(xOperador: String):Boolean;
begin
  if Estado = st_Venda_Aberta then
  begin
    GerarErro('Cupom Aberto !');
...
function TECF_Bematech_MP20_FI_II.Horario_Verao:Boolean;
begin
  if Estado = st_Venda_Aberta then
  begin
    GerarErro('Cupom Aberto !');
...
function TECF_Bematech_MP20_FI_II.Leitura_MF_Por_Data(xDe, xAte: TDateTime; xGeraArq: String = ''): Boolean;
var
  Arq: TextFile;
begin
  if Estado = st_Venda_Aberta then
...
function TECF_Bematech_MP20_FI_II.Leitura_MF_Por_Reducao(xDe, xAte: Integer; xGeraArq: String = ''): Boolean;
var
  Arq: TextFile;
begin
  if Estado = st_Venda_Aberta then
...
function TECF_Bematech_MP20_FI_II.Programar_Aliquotas(xPercentual: Currency; xISS: Boolean): Boolean;
begin
  Result := False;
  if xISS then
...
function TECF_Bematech_MP20_FI_II.Suprimento_de_Caixa(xValor: Currency): Boolean;
begin
  Result := Executa_Comando(#$19 + 'SU' + LFill(FormatFloat('#0', Trunc(xValor * 100)), '0', 14));
end;

function TECF_Bematech_MP20_FI_II.Sangria_de_Caixa(xValor: Currency): Boolean;
begin
  Result := Executa_Comando(#$19 + 'SA' + LFill(FormatFloat('#0', Trunc(xValor * 100)), '0', 14));
end;

function TECF_Bematech_MP20_FI_II.Abrir_Gaveta: Boolean;
begin
