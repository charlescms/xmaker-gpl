{$I XSqlDir.inc}
unit XSOdbc {$IFDEF XSQL_CLR} platform {$ENDIF};
...
type
  TSQLAllocConnect=
	  	function (henv :SQLHENV; var hdbc: SQLHDBC): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLAllocEnv=
  		function (var henv: SQLHENV): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLAllocHandle=
  		function(fHandleType: SQLSMALLINT; hInput: SQLHANDLE;
                    var hOutput: SQLHANDLE): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLAllocStmt=
  		function (hdbc: SQLHDBC; var hstmt: SQLHSTMT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLBindCol=	function (hstmt: SQLHSTMT; icol: SQLUSMALLINT; fCType: SQLSMALLINT;
                    rgbValue: SQLPOINTER; cbValueMax: SQLINTEGER;
                    pcbValue: SQLPOINTER{PSQLINTEGER}): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLCancel=	function (hstmt: SQLHSTMT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLCloseCursor=
  		function(hStmt: SQLHSTMT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLColAttribute=
  		function (hstmt: SQLHSTMT; icol, fDescType: SQLUSMALLINT;
                    rgbDesc: SQLPOINTER; cbDescMax: SQLSMALLINT;
                    pcbDesc: SQLPOINTER; pfDesc: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLColumns=	function (hStmt: SQLHSTMT;
                    ...
                    szColumnName: TSDCharPtr; cbColumnName: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLConnect=	function (hdbc: SQLHDBC; szDSN: TSDCharPtr; cbDSN: SQLSMALLINT;
                    szUID: TSDCharPtr; cbUID: SQLSMALLINT;
                    szAuthStr: TSDCharPtr; cbAuthStr: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLCopyDesc=
  		function (hDescSource: SQLHDESC; hDescTarget: SQLHDESC): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLDataSources =
  		function (hEnv: SQLHENV; fDirection: SQLUSMALLINT;
                    ...
                    var cbDescription: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLDescribeCol =
  		function (hstmt: SQLHSTMT; icol: SQLUSMALLINT;
                    ...
                    var cbColDef: SQLUINTEGER; var ibScale, fNullable: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLDisconnect =
  		function (hdbc: SQLHDBC): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLEndTran =	function (fHandleType: SQLSMALLINT; hHandle: SQLHANDLE; fType: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLError =	function (henv: SQLHENV; hdbc: SQLHDBC; hstmt: SQLHSTMT;
                    ...
                    var cbErrorMsg: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLExecDirect =
  		function (hstmt: SQLHSTMT; szSqlStr: TSDCharPtr; cbSqlStr: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLExecute =	function (hstmt: SQLHSTMT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLFetch =	function (hstmt: SQLHSTMT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLFetchScroll =
  		function (hStmt: SQLHSTMT;
  		    FetchOrientation: SQLSMALLINT; FetchOffset: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLFreeConnect =
  		function (hdbc: SQLHDBC): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLFreeEnv =	function (henv: SQLHENV): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLFreeHandle =
  		function (fHandleType: SQLSMALLINT; hHandle: SQLHANDLE): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLFreeStmt =
  		function (hstmt: SQLHSTMT; fOption: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetConnectAttr =
  		function (hDbc: SQLHDBC; Attribute: SQLINTEGER; Value: SQLPOINTER;
                    BufferLength: SQLINTEGER; pStringLength: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetConnectOption =
  		function (hDbc: SQLHDBC; fOption: SQLUSMALLINT; pvParam: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetCursorName =
  		function (hStmt: SQLHSTMT; szCursor: TSDCharPtr; cbCursorMax: SQLSMALLINT;
                    var cbCursor: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetData =	function (hStmt: SQLHSTMT; icol: SQLUSMALLINT; fCType: SQLSMALLINT;
                    rgbValue: SQLPOINTER; cbValueMax: SQLINTEGER;
                    var cbValue: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetDescField =
  		function (DescriptorHandle: SQLHDESC; RecNumber, FieldIdentifier: SQLSMALLINT;
                    Value: SQLPOINTER; BufferLength: SQLINTEGER;
                    var StringLength: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetDescRec =
  		function (DescriptorHandle: SQLHDESC; RecNumber: SQLSMALLINT;
                    ...
                    var Length: SQLINTEGER; var Precision, Scale, Nullable: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetDiagField =
  		function (fHandleType: SQLSMALLINT; hHandle: SQLHANDLE; iRecNumber: SQLSMALLINT;
                    ...
                    cbDiagInfoMax: SQLSMALLINT; pcbDiagInfo: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetDiagRec =
  		function (fHandleType: SQLSMALLINT; hHandle: SQLHANDLE; iRecNumber: SQLSMALLINT;
                    szSqlState: TSDCharPtr; var fNativeError: SQLINTEGER;
                    szErrorMsg: TSDCharPtr; cbErrorMsgMax: SQLSMALLINT;
  ...
  TSQLGetEnvAttr =
  		function(hEnv: SQLHENV; Attr: SQLINTEGER; Value: SQLPOINTER;
         		BufLen: SQLINTEGER; var StringLength: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetFunctions =
  		function (hDbc: SQLHDBC; fFunction: SQLUSMALLINT; var fExists: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetInfo =	function (hDbc: SQLHDBC; fInfoType: SQLUSMALLINT; rgbInfoValue: SQLPOINTER;
                    cbInfoValueMax: SQLSMALLINT; var cbInfoValue: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetStmtAttr =
  		function (hStmt: SQLHSTMT; Attribute: SQLINTEGER; Value: SQLPOINTER;
                    BufferLength: SQLINTEGER; var StringLength: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetStmtOption =
  		function (hStmt: SQLHSTMT; fOption: SQLUSMALLINT; pvParam: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLGetTypeInfo =
  		function (hStmt: SQLHSTMT; fSqlType: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLNumResultCols =
  		function (hStmt: SQLHSTMT; var ccol: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLParamData =
  		function (hStmt: SQLHSTMT; var gbValue: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLPrepare =	function (hStmt: SQLHSTMT; szSqlStr: TSDCharPtr; cbSqlStr: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLPutData =	function (hStmt: SQLHSTMT; rgbValue: SQLPOINTER; cbValue: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLRowCount =
  		function (hStmt: SQLHSTMT; var crow: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetConnectAttr =
  		function (hDbc: SQLHDBC; fOption: SQLINTEGER;
                    pvParam: SQLPOINTER; fStrLen: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetConnectOption =
  		function (hDbc: SQLHDBC; fOption: SQLUSMALLINT; vParam: SQLUINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetCursorName =
  		function (hStmt: SQLHSTMT; szCursor: TSDCharPtr; cbCursor: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetDescField =
  		function (DescriptorHandle: SQLHDESC; RecNumber, FieldIdentifier: SQLSMALLINT;
                    Value: SQLPOINTER; BufferLength: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetDescRec =
  		function (DescriptorHandle: SQLHDESC; RecNumber, RecType, RecSubType: SQLSMALLINT;
                    Length: SQLINTEGER; Precision, Scale: SQLSMALLINT;
                    Data: SQLPOINTER; var StringLength, Indicator: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetEnvAttr =
  		function(hEnv: SQLHENV; Attr: SQLINTEGER; Value: SQLPOINTER;
         		StringLength: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetParam =function (hStmt: SQLHSTMT; ipar: SQLUSMALLINT; fCType, fSqlType: SQLSMALLINT;
                    ...
                    rgbValue: SQLPOINTER; var cbValue: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetStmtAttr =
  		function (hStmt: SQLHSTMT; fOption: SQLINTEGER;
                    pvParam: SQLPOINTER; fStrLen: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetStmtOption =
  		function (hStmt: SQLHSTMT; fOption: SQLUSMALLINT; vParam: SQLUINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSpecialColumns =
  		function (hStmt: SQLHSTMT; fColType: SQLUSMALLINT;
                    szCatalogName: TSDCharPtr; cbCatalogName: SQLSMALLINT;
                    szSchemaName: TSDCharPtr; cbSchemaName: SQLSMALLINT;
                    szTableName: TSDCharPtr; cbTableName: SQLSMALLINT;
                    fScope, fNullable: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLStatistics =
  		function (hStmt: SQLHSTMT;
                    szCatalogName: TSDCharPtr; cbCatalogName: SQLSMALLINT;
                    szSchemaName: TSDCharPtr; cbSchemaName: SQLSMALLINT;
                    szTableName: TSDCharPtr; cbTableName: SQLSMALLINT;
                    fUnique, fAccuracy: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLTables =	function (hStmt: SQLHSTMT;
                    szCatalogName: TSDCharPtr; cbCatalogName: SQLSMALLINT;
                    szSchemaName: TSDCharPtr; cbSchemaName: SQLSMALLINT;
                    szTableName: TSDCharPtr; cbTableName: SQLSMALLINT;
                    szTableType: TSDCharPtr; cbTableType: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLTransact =function (hEnv: SQLHENV; hDbc: SQLHDBC; fType: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
...
********************************************************************************}
  TSQLBrowseConnect =
  		function(hDbc: SQLHDBC; szConnStrIn: TSDCharPtr; cbConnStrIn: SQLSMALLINT;
              		szConnStrOut: TSDCharPtr; cbConnStrOutMax: SQLSMALLINT;
                      	var cbConnStrOut: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLBulkOperations =
  		function(hStmt: SQLHSTMT; Operation: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLColAttributes =
  		function(hStmt: SQLHSTMT; icol, fDescType: SQLUSMALLINT; rgbDesc: SQLPOINTER;
              		cbDescMax: SQLSMALLINT; var cbDesc: SQLSMALLINT; var fDesc: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  TSQLDescribeParam =
  		function(hStmt: SQLHSTMT; ipar: SQLUSMALLINT; pfSqlType: SQLPOINTER;
              		var cbParamDef: SQLUINTEGER; pibScale, pfNullable: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLExtendedFetch =
  		function(hStmt: SQLHSTMT; fFetchType: SQLUSMALLINT; irow: SQLINTEGER;
              		var crow: SQLUINTEGER; var gfRowStatus: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLForeignKeys =
  		function(hStmt: SQLHSTMT; szPkCatalogName: TSDCharPtr; cbPkCatalogName: SQLSMALLINT;
              	szPkSchemaName: TSDCharPtr; cbPkSchemaName: SQLSMALLINT;
                      ...
                      szFkTableName: TSDCharPtr; cbFkTableName: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLMoreResults =
  		function(hStmt: SQLHSTMT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLNativeSql =
  		function(hDbc: SQLHDBC; szSqlStrIn: TSDCharPtr; cbSqlStrIn: SQLINTEGER;
  			szSqlStr: TSDCharPtr; cbSqlStrMax: SQLINTEGER; var cbSqlStr: SQLINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLNumParams =
  		function(hStmt: SQLHSTMT; var cpar: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLParamOptions =
  		function(hStmt: SQLHSTMT; crow: SQLUINTEGER; var irow: SQLUINTEGER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLPrimaryKeys =
  		function(hStmt: SQLHSTMT; szCatalogName: TSDCharPtr; cbCatalogName: SQLSMALLINT;
  			szSchemaName: TSDCharPtr; cbSchemaName: SQLSMALLINT;
  			szTableName: TSDCharPtr; cbTableName: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  TSQLProcedures =
  		function(hStmt: SQLHSTMT; szCatalogName: TSDCharPtr; cbCatalogName: SQLSMALLINT;
  			szSchemaName: TSDCharPtr; cbSchemaName: SQLSMALLINT;
  			szProcName: TSDCharPtr; cbProcName: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLSetPos =
  		function(hStmt: SQLHSTMT; irow, fOption, fLock: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLTablePrivileges =
  		function(hStmt: SQLHSTMT; szCatalogName: TSDCharPtr; cbCatalogName: SQLSMALLINT;
              	szSchemaName: TSDCharPtr; cbSchemaName: SQLSMALLINT;
                      szTableName: TSDCharPtr; cbTableName: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLDrivers =
  		function(hEnv: SQLHENV; fDirection: SQLUSMALLINT; szDriverDesc: TSDCharPtr;
              		cbDriverDescMax: SQLSMALLINT; var cbDriverDesc: SQLSMALLINT;
                      	szDriverAttributes: TSDCharPtr; cbDrvrAttrMax: SQLSMALLINT; var cbDrvrAttr: SQLSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLBindParameter =
  		function(hStmt: SQLHSTMT; ipar: SQLUSMALLINT;
  			fParamType, fCType, fSqlType: SQLSMALLINT;
  			cbColDef: SQLUINTEGER; ibScale: SQLSMALLINT;
  			rgbValue: SQLPOINTER; cbValueMax: SQLINTEGER;
                        pcbValue: SQLPOINTER): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  TSQLDriverConnect =
  		function(hDbc: SQLHDBC; hWnd: SQLHWND;
                	szConnStrIn: TSDCharPtr; cbConnStrIn: SQLSMALLINT;
                        szConnStrOut: TSDCharPtr; cbConnStrOutMax: SQLSMALLINT;
                        var cbConnStrOut: SQLSMALLINT; fDriverCompletion: SQLUSMALLINT): SQLRETURN; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
...
begin
  Result := Assigned( GetProcAddress(FLibHandle, {$IFDEF XSQL_CLR}AName{$ELSE}PChar(AName){$ENDIF}) );
end;
...
begin
  Result := IsDateTimeType( FieldType ) {$IFDEF XSQL_VCL5} or (FieldType = ftGuid) {$ENDIF};
end;
...
begin
  case ExtDataType of
    ...
    SQL_BIGINT: 	Result := {$IFDEF XSQL_VCL4} ftLargeInt {$ELSE} ftInteger {$ENDIF};
...
{$ENDIF}
    ...
    if IsBlobType(Params[i].DataType) then begin
      ...
      if {$IFDEF XSQL_CLR}Params[i].Value = ''{$ELSE}PChar(TVarData(Params[i].Value).VString) = nil{$ENDIF} then
        FieldInfo.FetchStatus := SQL_NULL_DATA
      else
    ...
    if rcd = SQL_NEED_DATA then begin
      ...
      while rcd = SQL_NEED_DATA do
        with Params[Integer(pValue)] do begin
          sBlob := AsBlob;
          WriteBlob( Integer(pValue), {$IFDEF XSQL_CLR}BufList.StringToPtr(sBlob){$ELSE}PChar(sBlob){$ENDIF}, Length(sBlob) );
