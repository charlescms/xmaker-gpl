{$I XSqlDir.inc}
unit XSInt {$IFDEF XSQL_CLR} platform {$ENDIF};
...
{$ENDIF}
  ...
  PISC_BLOB_DESC = {$IFDEF XSQL_CLR} Void {$ELSE} ^TISC_BLOB_DESC {$ENDIF};

  (*****************************)
  (** Blob control structure  **)
  (*****************************)
  TISC_BLOB_CTL_SOURCE_FUNCTION = function: ISC_STATUS; // ISC_FAR
  PISC_BLOB_CTL                 = {$IFDEF XSQL_CLR}Void{$ELSE}^TISC_BLOB_CTL{$ENDIF};        // ISC_FAR
...
{ TIntFunctions }
  ...
  isc_attach_database : function(
      ...
      parm_buffer              : TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_blob_default_desc : procedure(
      desc		       : PISC_BLOB_DESC;
      table_name               : TSDCharPtr;
      column_name              : TSDCharPtr); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_blob_gen_bpb : function(
      ...
      bpb_length               : PUShort): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_blob_info : function(
      ...
      result_buffer            : TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_blob_lookup_desc : function(
      ...
      desc                     : PISC_BLOB_DESC;
      global_column_name       : TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_blob_set_desc : function(
      ...
      charset,
      segment_size             : Short;
      desc                     : PISC_BLOB_DESC): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_cancel_blob : function(
      status_vector            : PISC_STATUS;
      var blob_handle          : TISC_BLOB_HANDLE): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_cancel_events : function(
      status_vector            : PISC_STATUS;
      db_handle                : PISC_DB_HANDLE;
      event_id                 : PISC_LONG): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_commit_retaining : function(
      status_vector             : PISC_STATUS;
      tran_handle               : PISC_TR_HANDLE): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_create_blob : function(
      ...
      var blob_handle          : TISC_BLOB_HANDLE;
      blob_id                  : PISC_QUAD): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_create_blob2 : function(
      ...
      blob_id                  : PISC_QUAD;
      bpb_length               : Short;
      bpb_address              : TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_create_database  : function(
      ...
      parm_7                   : Short): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_decode_date : procedure(
      ib_date: 		PISC_QUAD;
      var tm_date: 	TTimeDateRec); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_detach_database : function(
      status_vector            : PISC_STATUS;
      db_handle                : PISC_DB_HANDLE): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_dsql_allocate_statement : function(
      status_vector            : PISC_STATUS;
      db_handle                : PISC_DB_HANDLE;
      stmt_handle              : PISC_STMT_HANDLE): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_dsql_describe : function(
      ...
      dialect                  : UShort;
      xsqlda                   : PXSQLDA): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_dsql_execute2 : function(
      ...
      dialect                  : UShort;
      in_xsqlda,
      out_xsqlda               : PXSQLDA): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_dsql_exec_immed2 : function(
      ...
      statement                : TSDCharPtr;
      dialect                  : UShort;
      in_xsqlda, out_xsqlda    : PXSQLDA): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_dsql_free_statement : function(
      status_vector            : PISC_STATUS;
      stmt_handle              : PISC_STMT_HANDLE;
      option                   : UShort): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_dsql_set_cursor_name : function(
      ...
      type_reserved            : UShort): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_dsql_sql_info : function(
      ...
      items                     : TSDCharPtr;
      buffer_length             : Short;
      buffer                    : TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_encode_date : procedure(
      	var tm_date:	TTimeDateRec;
      	ib_date:	PISC_QUAD); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_encode_sql_date : procedure(
  	var tm_date: 	TTimeDateRec;
        ib_date: 	PISC_DATE); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_encode_sql_time : procedure(
  	var tm_date: 	TTimeDateRec;
        ib_time:	PISC_TIME); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_encode_timestamp : procedure(
  	var tm_date: 	TTimeDateRec;
        ib_timestamp:	PISC_TIMESTAMP); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_event_counts : procedure(
      status_vector             : PISC_STATUS;
      buffer_length             : Short;
      event_buffer              : TSDCharPtr;
      result_buffer             : TSDCharPtr); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_get_segment : function(
      ...
      seg_buffer                : TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_interprete : function(
      buffer                    : TSDCharPtr;
      var status_vector         : PISC_STATUS): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_open_blob2 : function(
      ...
      blob_id                   : TISC_QUAD;
      bpb_length                : Short;
      bpb_buffer                : TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_prepare_transaction2 : function(
      ...
      tran_handle               : PISC_TR_HANDLE;
      msg_length		: Short;
      msg			: TSDCharPtr): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_print_sqlerror : procedure(
      sqlcode                   : Short;
      status_vector             : PISC_STATUS); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_print_status : function(
      status_vector             : PISC_STATUS): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_start_multiple : function (
      ...
      var teb_vector_address    : TISC_TEB): ISC_STATUS; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_sqlcode: 		function(
      var status_vector             : PISC_STATUS): ISC_LONG; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_sql_interprete: 	procedure(
      sql_code			: Short;
      buffer                    : TSDCharPtr;
      buffer_length             : Short); {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
  ...
  isc_vax_integer : function(
      buffer                    : TSDCharPtr;
      length                    : Short): ISC_LONG; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

  isc_version : function(
      db_handle                 : PISC_DB_HANDLE;
      isc_arg2                  : TISC_CALLBACK;
      isc_arg3                  : PVoid): Int; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}

	// Security Functions

  isc_add_user : function(
      status_vector             : PISC_STATUS;
      var user_sec_data         : TUSER_SEC_DATA): Int; {$IFNDEF XSQL_CLR} stdcall; {$ENDIF}
...
begin
  ...
  if Assigned(TRHandle) {$IFNDEF XSQL_CLR}and Assigned(TRHandle^){$ENDIF} then begin
  ...
  // then we can detach
  if Assigned(DBHandle) {$IFNDEF XSQL_CLR}and Assigned(DBHandle^){$ENDIF} then begin
...
{$ENDIF}
      ...
      if IsBlobType(Params[i].DataType) then begin
        ...
        IBWriteBlobParam( PISC_QUAD(SqlVar.sqldata), {$IFDEF XSQL_CLR}BufList.StringToPtr(sBlob){$ELSE}PChar(sBlob){$ENDIF}, Length(sBlob) );
          ...
          ftString:
            begin
              if (SqlVar.sqltype and not 1) = SQL_TEXT then begin
                Params[i].AsString :=
{$IFDEF XSQL_CLR}	Marshal.PtrToStringAnsi(SqlVar.sqldata, SqlVar.sqllen);
{$ELSE}                	Copy(SqlVar.sqldata, 0, SqlVar.sqllen);
{$ENDIF}
              end else // SQL_VARYING
                Params[i].AsString :=
{$IFDEF XSQL_CLR}	Marshal.PtrToStringAnsi( IncPtr(SqlVar.sqldata, SizeOf(Short)), HelperMemReadInt16(SqlVar.sqldata, 0) );
...
begin
  ...
  if not (FieldType in [ftSmallInt, ftInteger, {$IFDEF XSQL_VCL4}ftLargeInt,{$ENDIF} ftBCD]) then
    Exit;
  Scale := Abs(Scale);
  if Scale > 0 then
...
{$IFNDEF XSQL_VCL4} 	// for Delphi 3 in case of SQL_INT64
...
begin
  ...
  case ExtDataType of
    ...
    SQL_INT64:		Result := {$IFDEF XSQL_VCL4} ftLargeInt {$ELSE} ftBCD {$ENDIF};	// 580	for DECIMAL(10+, ..)
  else
    Result := ftUnknown;
  end;
end;
