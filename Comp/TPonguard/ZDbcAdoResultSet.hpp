...
// (DO NOT EDIT: machine generated header) 'ZDbcAdoResultSet.pas' rev: 5.00
...
public:
	__fastcall TZAdoResultSet(Zdbcintfs::_di_IZStatement Statement, AnsiString SQL, Zplainado::_di_Recordset15 
		AdoRecordSet);
...
public:
	__fastcall TZAdoCachedResolver(Zplainado::_di_Connection15 Handle, Zdbcintfs::_di_IZStatement Statement
		, Zdbcintfs::_di_IZResultSetMetadata Metadata);
