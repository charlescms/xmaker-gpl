...
// (DO NOT EDIT: machine generated header) 'ZDbcDbLibMsSqlMetadata.pas' rev: 5.00

#ifndef ZDbcDbLibMsSqlMetadataHPP
#define ZDbcDbLibMsSqlMetadataHPP
...
namespace Zdbcdblibmssqlmetadata
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TZMsSqlDatabaseMetadata;
class PASCALIMPLEMENTATION TZMsSqlDatabaseMetadata : public Zdbcmetadata::TZAbstractDatabaseMetadata 
...
public:
	__fastcall TZMsSqlDatabaseMetadata(Zdbcconnection::TZAbstractConnection* Connection, AnsiString Url
		, Classes::TStrings* Info);
	__fastcall virtual ~TZMsSqlDatabaseMetadata(void);
...
using namespace Zdbcdblibmssqlmetadata;
#endif
#pragma option pop	// -w-
