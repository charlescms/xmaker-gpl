...
{$IFDEF VER130BELOW}
  Comobj,
{$ENDIF}
  ZClasses, ZDbcIntfs, ZTokenizer,ZCompatibility;
...
type
  ...
  protected
    constructor Create(Url: string; HostName: string; Port: Integer;
...
constructor TZAbstractConnection.Create(Url: string; HostName: string;
