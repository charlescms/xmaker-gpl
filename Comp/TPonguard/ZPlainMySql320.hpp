...
// (DO NOT EDIT: machine generated header) 'ZPlainMySql320.pas' rev: 5.00

#ifndef ZPlainMySql320HPP
#define ZPlainMySql320HPP
...
typedef void __stdcall (*Tmysql_data_seek)(PMYSQL_RES Result, unsigned Offset);
...
//-- var, const, procedure ---------------------------------------------------
#define WINDOWS1_DLL_LOCATION "libmysql320.dll"
...
using namespace Zplainmysql320;
#endif
#pragma option pop	// -w-
