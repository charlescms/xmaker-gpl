...
// (DO NOT EDIT: machine generated header) 'ZPlainInterbase5.pas' rev: 5.00

#ifndef ZPlainInterbase5HPP
#define ZPlainInterbase5HPP
...
//-- var, const, procedure ---------------------------------------------------
#define WINDOWS_DLL_LOCATION "gds32.dll"
#define LINUX_DLL_LOCATION "libgds.so"
...
extern PACKAGE void __fastcall isc_encode_sql_date_stub(Zplaininterbasedriver::PCTimeStructure tm_date
	, Zplaininterbasedriver::PISC_DATE ib_date);
extern PACKAGE void __fastcall isc_encode_sql_time_stub(Zplaininterbasedriver::PCTimeStructure tm_date
	, Zplaininterbasedriver::PISC_TIME ib_time);
extern PACKAGE void __fastcall isc_encode_timestamp_stub(Zplaininterbasedriver::PCTimeStructure tm_date
	, Zplaininterbasedriver::PISC_TIMESTAMP ib_timestamp);
extern PACKAGE void __fastcall isc_decode_sql_date_stub(Zplaininterbasedriver::PISC_DATE ib_date, Zplaininterbasedriver::PCTimeStructure 
	tm_date);
extern PACKAGE void __fastcall isc_decode_sql_time_stub(Zplaininterbasedriver::PISC_TIME ib_time, Zplaininterbasedriver::PCTimeStructure 
	tm_date);
extern PACKAGE void __fastcall isc_decode_timestamp_stub(Zplaininterbasedriver::PISC_TIMESTAMP ib_timestamp
	, Zplaininterbasedriver::PCTimeStructure tm_date);

}	/* namespace Zplaininterbase5 */
#if !defined(NO_IMPLICIT_NAMESPACE_USE)
using namespace Zplaininterbase5;
#endif
#pragma option pop	// -w-
