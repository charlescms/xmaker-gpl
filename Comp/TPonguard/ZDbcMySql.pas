...
type
  ...
  public
    constructor Create(Url: string; PlainDriver: IZMySQLPlainDriver;
...
uses
  ...
  ZDbcMySqlUtils, ZDbcMySqlMetadata;
...
begin
  ...
  else Result := FMySQL40PlainDriver;
  Result.Initialize;
end;
...
constructor TZMySQLConnection.Create(Url: string;
