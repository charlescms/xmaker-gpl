...
uses Classes, ZDbcConnection, ZDbcIntfs, ZCompatibility, ZPlainDriver,
...
type
  ...
  public
    constructor Create(Url: string; PlainDriver: IZPlainDriver; HostName: string; Port: Integer;
...
begin
  ...
  try
    ...
    Result := TZAdoConnection.Create(Url, PlainDriver, HostName, Port, Database,
      UserName, Password, TempInfo);
  finally
    TempInfo.Free;
  end;
...
constructor TZAdoConnection.Create(Url: string; PlainDriver: IZPlainDriver;
