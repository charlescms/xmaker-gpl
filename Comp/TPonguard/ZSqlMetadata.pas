...
type
  ...
  TZMetadataType = (mdProcedures, mdProcedureColumns, mdTables, mdSchemas,
    ...
    mdExportedKeys, mdCrossReference, mdTypeInfo, mdIndexInfo,
    mdUserDefinedTypes);
...
begin
  ...
  try
    ...
    case FMetadataType of
      ...
      mdColumns:
        Result := Metadata.GetColumns(FCatalog, FSchema, FTableName, FColumnName);
      mdColumnPrivileges:
        begin
          Result := Metadata.GetColumnPrivileges(FCatalog, FSchema,
