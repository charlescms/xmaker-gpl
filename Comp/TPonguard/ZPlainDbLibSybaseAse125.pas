...
type
  ...
  Tdb12hour = function(Proc: PDBPROCESS; Language: PChar): DBBOOL; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
...
{ Standard DB-Library functions }
  ...
  Tdbcolbrowse = function(Proc: PDBPROCESS; Column: Integer): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
...
//  Tdbcoltypeinfo = function(Proc: PDBPROCESS; Column: Integer): PDBTYPEINFO; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  Tdbdead = function(Proc: PDBPROCESS): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  Tdbexit = procedure; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  Tdbfcmd = function(Proc: PDBPROCESS; CmdString: PChar; var Params): RETCODE; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  Tdbloginfree = procedure(Login: PLOGINREC); {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  Tdbhasretstat = function(Proc: PDBPROCESS): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  Tdbinit = function: RETCODE; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  Tdbisavail = function(Proc: PDBPROCESS): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  Tdbisopt = function(Proc: PDBPROCESS; Option: Integer; Param: PChar): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  Tdbsetlname = function(Login: PLOGINREC; Value: PChar; Item: Integer): RETCODE; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  Tdbtabbrowse = function(Proc: PDBPROCESS; TabNum: Integer): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  ...
  Tdbvarylen = function(Proc: PDBPROCESS; Column: Integer): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
  Tdbwillconvert = function(SrcType, DestType: Integer): LongBool; {$IFNDEF LINUX} stdcall {$ELSE} cdecl {$ENDIF};
