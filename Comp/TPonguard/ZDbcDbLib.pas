...
type
  ...
  public
    constructor Create(Url: string; PlainDriver: IZDBLibPlainDriver;
...
uses
  ...
  ZDbcDbLibMsSqlMetadata, ZDbcDbLibSybaseMetadata;
...
begin
  ...
  try
    ...
    Result := TZDBLibConnection.Create(Url, PlainDriver, HostName, Port,
...
constructor TZDBLibConnection.Create(Url: string;
