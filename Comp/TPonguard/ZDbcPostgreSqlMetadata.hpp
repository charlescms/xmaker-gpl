...
// (DO NOT EDIT: machine generated header) 'ZDbcPostgreSqlMetadata.pas' rev: 5.00

#ifndef ZDbcPostgreSqlMetadataHPP
#define ZDbcPostgreSqlMetadataHPP
...
#include <ZDbcPostgreSqlUtils.hpp>	// Pascal unit
...
namespace Zdbcpostgresqlmetadata
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TZPostgreSQLDatabaseMetadata;
class PASCALIMPLEMENTATION TZPostgreSQLDatabaseMetadata : public Zdbcmetadata::TZAbstractDatabaseMetadata 
...
protected:
	Zdbcresultsetmetadata::TZColumnInfo* __fastcall GetColumnInfo(AnsiString Table, AnsiString Name, Zdbcintfs::TZSQLType 
		SQLType, int Length);
	Zdbcmetadata::TZVirtualResultSet* __fastcall GetVirtualResultSet(Contnrs::TObjectList* ColumnsInfo)
		;
	bool __fastcall HaveMinimumServerVersion(int MajorVersion, int MinorVersion);
	int __fastcall GetMaxIndexKeys(void);
	int __fastcall GetMaxNameLength(void);
	AnsiString __fastcall GetPostgreSQLType(int Oid);
	Zdbcintfs::TZSQLType __fastcall GetSQLTypeByOid(int Oid);
	Zdbcintfs::TZSQLType __fastcall GetSQLTypeByName(AnsiString TypeName);
	AnsiString __fastcall TableTypeSQLExpression(AnsiString TableType, bool UseSchemas);
	void __fastcall ParseACLArray(Classes::TStrings* List, AnsiString AclString);
	AnsiString __fastcall GetPrivilegeName(char Permission);
	Zdbcintfs::_di_IZResultSet __fastcall GetImportedExportedKeys(AnsiString PrimaryCatalog, AnsiString 
		PrimarySchema, AnsiString PrimaryTable, AnsiString ForeignCatalog, AnsiString ForeignSchema, AnsiString 
		ForeignTable);
	
public:
	__fastcall TZPostgreSQLDatabaseMetadata(Zdbcconnection::TZAbstractConnection* Connection, AnsiString 
		Url, Classes::TStrings* Info);
	__fastcall virtual ~TZPostgreSQLDatabaseMetadata(void);
...
using namespace Zdbcpostgresqlmetadata;
#endif
#pragma option pop	// -w-
