...
// (DO NOT EDIT: machine generated header) 'ZDbcDbLibSybaseMetadata.pas' rev: 5.00

#ifndef ZDbcDbLibSybaseMetadataHPP
#define ZDbcDbLibSybaseMetadataHPP
...
namespace Zdbcdblibsybasemetadata
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TZSybaseDatabaseMetadata;
class PASCALIMPLEMENTATION TZSybaseDatabaseMetadata : public Zdbcmetadata::TZAbstractDatabaseMetadata 
...
public:
	__fastcall TZSybaseDatabaseMetadata(Zdbcconnection::TZAbstractConnection* Connection, AnsiString Url
		, Classes::TStrings* Info);
	__fastcall virtual ~TZSybaseDatabaseMetadata(void);
...
using namespace Zdbcdblibsybasemetadata;
#endif
#pragma option pop	// -w-
