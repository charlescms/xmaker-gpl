...
// (DO NOT EDIT: machine generated header) 'ZPlainPostgreSql73.pas' rev: 5.00

#ifndef ZPlainPostgreSql73HPP
#define ZPlainPostgreSql73HPP
...
typedef void __cdecl (*TPQfreeNotify)(PPGnotify Handle);
...
//-- var, const, procedure ---------------------------------------------------
#define WINDOWS1_DLL_LOCATION "libpq73.dll"
...
extern PACKAGE TPQfreeNotify PQfreeNotify;
...
using namespace Zplainpostgresql73;
#endif
#pragma option pop	// -w-
